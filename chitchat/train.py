...
def setup_train_args():
    ...
    parser.add_argument('--device', default='0,1', type=str, required=False, help='GPU使用')
    parser.add_argument('--no_cuda', action='store_true', help='不使用GPU')
    parser.add_argument('--model_config', default='dialogue_model/config.json', type=str, required=False,
                        help='定义模型参数')
    parser.add_argument('--vocab_path', default='dialogue_model/vocab.txt', type=str, required=False, help='词表路径')
    ...
    parser.add_argument('--train_tokenized_path', default='data/train_tokenized.txt', type=str,
                        required=False,
                        help='tokenizer之后语料的存放位置')
    parser.add_argument('--log_path', default='log/training.log', type=str, required=False, help='训练日志路径')
    parser.add_argument('--raw', action='store_true', help='是否是原始语料')
    ...
    parser.add_argument('--warmup_steps', default=2000, type=int, required=False, help='warmup')
    parser.add_argument('--log_step', default=100, type=int, required=False, help='log保存频率')
    parser.add_argument('--gradient_accumulation', default=1, type=int, required=False, help='梯度积步数')
    parser.add_argument('--max_grad_norm', default=1.0, type=float, required=False,help='梯度裁剪大小')
    parser.add_argument('--dialogue_model_output_path', default='gpt2/', type=str, required=False,
                        help='对话模型输出路径')
    ...
    parser.add_argument('--num_workers', type=int, default=1, help="dataloader加载数据线程数量")
